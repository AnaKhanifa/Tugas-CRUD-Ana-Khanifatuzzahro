                ...
                <div class="card-body">
                    <form  method="POST" action="{{url('hp')}}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-4">
                            <input type="text" class="form-control form-control-sm @error('txtbrand') is-invalid @enderror" id="txtbrand" name="txtbrand" value="{{ old('txtbrand') }}">
                            @error('txtbrand')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-6">
                            <input type="number" name="txtharga" id="txtharga" class="form-control form-control-sm @error('txtharga') is-invalid @enderror" value="{{ old('txtharga') }}">
                            @error('txtharga')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
